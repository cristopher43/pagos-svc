# Delivery — Despliegue y operación
...
| API base | `/api/entregas` |

## Docker

```bash
docker build -t duoc/jv0101-caso05-delivery:1.0.0 .
docker run -p 8080:8080 duoc/jv0101-caso05-delivery:1.0.0
```
